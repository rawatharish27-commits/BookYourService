...
import { qualityService } from '../services/QualityIntelligenceService';
    ...
    return (
      <div className="max-w-md mx-auto space-y-12 py-20 px-10 animate-fadeIn font-inter">
        ...
        <div className="bg-white p-10 rounded-[4rem] border-4 border-slate-100 shadow-2xl space-y-8">
          ...
          {(user?.verificationStatus === VerificationStatus.KYC_PENDING || user?.verificationStatus === VerificationStatus.ADMIN_APPROVED) && (
